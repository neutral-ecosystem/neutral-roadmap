...
| Astro build, Cloudflare Pages, watched paths, and deployment | [Documentation hosting rules](HOSTING.md) |
| Public sections, URLs, and navigation | [Website content map](../website/CONTENT-MAP.md) |

The publishing flow is:

```text
domain Markdown -> Astro in website/ -> website/dist/ -> Cloudflare Pages
```
