...
| `0.1` | binary32, default nearest-even | Accept: bits `0x3dcccccd` |
| `0.1` | binary64, `exact` | Reject: not exactly representable |
| `0.1` | binary64, default nearest-even | Accept: bits `0x3fb999999999999a` |
...
| `16_777_217` | binary32, default nearest-even | Accept as `16_777_216`, bits `0x4b800000` |
| `340_282_360_000_000_000_000_000_000_000_000_000_000` | binary32, either policy | Reject: overflow |
| `0.00000000000000000000000000000000000000000000000001` | binary32, default nearest-even | Accept as positive zero, bits `0x00000000` |
| `-0.00000000000000000000000000000000000000000000000001` | binary32, default nearest-even | Accept as negative zero, bits `0x80000000` |
